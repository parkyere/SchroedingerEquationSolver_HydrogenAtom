...
// UV-sphere triangle soup; shared directions (j % segments wrap) weld
// seams/poles bitwise -> watertight by construction.
...
// Normals are unit but not outward-oriented; mesh shader lights with
// abs(dot(n, view)).
